module Layer_3 import nn_definitions_pkg::*; (
    input logic clk,
    input logic rst,
    ...
    input logic [$clog2(NUM_INPUTS_LAYER3)-1:0] config_addr,
...
assign m_axis_tlast = (shift_count == 1) && m_axis_tvalid;
    ...
    Node #(
        .Layer_num(3), .Node_num(0), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_0.mif"),
        .biasFile("b_3_0.mif")
    ) n_0 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 0)),
    ...
    Node #(
        .Layer_num(3), .Node_num(1), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_1.mif"),
        .biasFile("b_3_1.mif")
    ) n_1 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 1)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(2), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_2.mif"),
        .biasFile("b_3_2.mif")
    ) n_2 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 2)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(3), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_3.mif"),
        .biasFile("b_3_3.mif")
    ) n_3 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 3)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(4), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_4.mif"),
        .biasFile("b_3_4.mif")
    ) n_4 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 4)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(5), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_5.mif"),
        .biasFile("b_3_5.mif")
    ) n_5 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 5)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(6), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_6.mif"),
        .biasFile("b_3_6.mif")
    ) n_6 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 6)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(7), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_7.mif"),
        .biasFile("b_3_7.mif")
    ) n_7 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 7)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(8), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_8.mif"),
        .biasFile("b_3_8.mif")
    ) n_8 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 8)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
    ...
    Node #(
        .Layer_num(3), .Node_num(9), .Weight_num(NUM_INPUTS_LAYER3),
        .weightFile("w_3_9.mif"),
        .biasFile("b_3_9.mif")
    ) n_9 (
        .clk(clk), .rst(rst),
        .config_en(config_en && (config_layer_num == 3) && (config_node_num == 9)),
        .config_is_bias(config_is_bias),
        .config_addr(config_addr),
        .config_data(config_data),
        .givenInput(s_axis_tdata),
